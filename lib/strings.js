...
(function (root, factory) {
  ...
  const BASS_METHODS = {
    simandl: {
      id: "simandl",
      label: "Simandl",
      detail: "1–2–4 fingering · ½ through VII",
      fingering: "1-2-4",
      positions: [
  ...
  function resolveUprightDiagram(instrumentId, root, intervals, capo = 0, tuning = null, opts = {}) {
    ...
    const { startFret, endFret } = neckRangeForPositions(method, activePositions, neckFrets);
    ...
    return {
      ...
      startFret,
      endFret,
      fretsShown: Math.max(1, endFret - (startFret > 0 ? startFret : 0)),
      fretRatios: fretCellRatios(Math.max(1, startFret || 1), endFret),
